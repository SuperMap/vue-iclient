...
export default {
  ...
  data() {
    ...
    return {
      ...
      iportalDataQuery: [
        new SmWidgets.commontypes.iPortalDataParameter({
          url: "http://192.168.12.230:8092/web/datas/1962026684",
          attributeFilter: "SmID>0"
        })
      ],
      restDataQuery: [
        new SmWidgets.commontypes.RestDataParameter({
      ...
      restMapQuery: [
        new SmWidgets.commontypes.RestMapParameter({
      ...
      addressMatch: [
        new SmWidgets.commontypes.AddressMatchParameter({
          url:
  ...
  methods: {
    ...
    changeStyle() {
      console.log(SmWidgets.commontypes);
      SmWidgets.setTheme("dark");
    },
    changeStyle1() {
      SmWidgets.setTheme("light");
    }
  }
};
</script>
