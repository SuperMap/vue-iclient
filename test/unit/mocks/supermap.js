...
SuperMap.ColorsPickerUtil.getGradientColors = function () {
    return ["#d53e4f", "#d6404f", "#dd4f51", "#de5151", "#df5351", "#e05652", "#e25852", "#e35a52", "#e45c52", "#e55e53", "#e66153", "#e76353", "#e86553", "#e96754", "#ea6954", "#eb6c54", "#ec6e55", "#ed7055", "#ef7255", "#f07455", "#f17756", "#f27956", "#f37b56", "#f47d57", "#f57f57", "#f68257", "#f78457", "#f88658", "#f98858", "#fa8a58", "#fc8d59", "#fc8f5a", "#fc915b", "#fc935d", "#fc965e", "#fc985f", "#fc9a61", "#fc9d62", "#fc9f64", "#fca165", "#fca466", "#fca668", "#fca869", "#fcaa6b", "#fcad6c", "#fcaf6d", "#fcb16f", "#fcb470", "#fcb671", "#fdb873", "#fdbb74", "#fdbd76", "#fdbf77", "#fdc278", "#fdc47a", "#fdc67b", "#fdc87d", "#fdcb7e", "#fdcd7f", "#fdcf81", "#fdd282", "#fdd484", "#fdd685", "#fdd986", "#fddb88", "#fddd89", "#fee08b", "#fee08c", "#fee18d", "#fee28f", "#fee390", "#fee492", "#fee593", "#fee695", "#fee696", "#fee798", "#fee899", "#fee99a", "#feea9c", "#feeb9d", "#feec9f", "#feeca0", "#feeda2", "#feeea3", "#feefa5", "#fef0a6", "#fef1a7", "#fef2a9", "#fef2aa", "#fef3ac", "#fef4ad", "#fef5af", "#fef6b0", "#fef7b2", "#fef8b3", "#fef8b4", "#fef9b6", "#fefab7", "#fefbb9", "#fefcba", "#fefdbc", "#fefebd", "#fdfebc", "#fcfebb"
        , "#fcfdba", "#fbfdb9", "#fafdb8", "#fafdb7", "#f9fcb6", "#f8fcb5", "#f8fcb4", "#f7fbb3", "#f6fbb1", "#f5fbb0", "#f5fbaf", "#f4faae", "#f3faad", "#f3faac", "#f2faab", "#f1f9aa", "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#ecf7a2", "#ecf7a1", "#ebf7a0", "#eaf69f", "#f8fcb5", "#f8fcb4", "#f7fbb3", "#f6fbb1", "#f5fbb0", "#f5fbaf", "#f4faae", "#f3faad", "#f3faac", "#f2faab", "#f1f9aa", "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#ecf7a2", "#ecf7a1", "#ebf7a0", "#eaf69f", "#519fb0"
        , "#f8fcb4", "#f7fbb3", "#f6fbb1", "#f5fbb0", "#f5fbaf", "#f4faae", "#f3faad", "#f3faac", "#f2faab", "#f1f9aa", "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#ecf7a2", "#ecf7a1", "#ebf7a0", "#eaf69f", "#f8fcb5", "#f8fcb4", "#f7fbb3", "#f6fbb1", "#f5fbb0", "#f5fbaf", "#f4faae", "#f3faad", "#f3faac", "#f2faab", "#f1f9aa", "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#ecf7a2", "#ecf7a1", "#ebf7a0", "#eaf69f", "#519fb0"
        , "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#f5fbaf", "#f4faae", "#f3faad", "#f3faac", "#f2faab", "#f1f9aa", "#f1f9a9", "#f0f9a8", "#eff8a7", "#eff8a6", "#eef8a4", "#edf8a3", "#ecf7a2", "#ecf7a1", "#ebf7a0", "#eaf69f", "#519fb0"
    ]
}
import {
    featureResults, datas, datasources, datasets, queryResults, fakeLandUse, chartResult, datas_chart, iportal_content, datas_mapjson, charts_content, localSearch, search_mapjson
    , fieldsJson, datas_beijing
} from "./services"
    ...
    get: function (url, params, options) {
        ...
        return new Promise((resolve, reject) => {
            ...
            //2040117719
                ...
                process.nextTick(() =>
                    resolve(new Response(JSON.stringify(datas_beijing)))
                )
            }
            ...
            ///iserver/services/data-world/rest/data/datasources/World/datasets/Countries/fields.rjson.json
                ...
                console.log("rjson")
                process.nextTick(() =>
                    resolve(new Response(JSON.stringify(fieldsJson)))
                )
            }
            ...
            // http://www.supermapol.com/iserver/services/localsearch/rest/searchdatas/China/poiinfos.json?keywords=%E5%8C%97%E4%BA%AC&city=%E5%8C%97%E4%BA%AC%E5%B8%82&pageSize=10&pageNum=1&key=fvV2osxwuZWlY0wJb8FEb2i5 
                ...
                process.nextTick(() =>
                    resolve(new Response(JSON.stringify(searchGeocoding)))
                )
            }
