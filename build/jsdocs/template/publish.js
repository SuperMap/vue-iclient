...
/**
 * 获取注释中的命名空间和类名，进行排序后返回
 * @param {} members 
 */
function sortNav(members) {
    var merged
    // if (members.classes != undefined && members.classes.length > 0) {
    //     merged = members.namespaces.concat(members.classes);
    // }
    // } else {
    //     console.log("modules: "+ members.modules)
    //     merged = members.modules;
    // }
    merged = members.namespaces.concat(members.classes);
