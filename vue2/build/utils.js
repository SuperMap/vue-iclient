...
exports.getMapLibName = () => {
  const libNames = ['mapboxgl', 'leaflet'];
  const matchMapLibName = libNames.find(name => process.argv.includes(`--${name}`));
  return matchMapLibName || libNames[0];
};
