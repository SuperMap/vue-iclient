...
export default {
  title: `${toI18n('customizeTheme.title')}/${toI18n('customizeTheme.customTheme')}`,
  id: 'Design/CustomTheme',
...
export const CustomTheme = () => ({
  ...
  props: {
    defaultStyle: { default: select('defaultStyle', ['light', 'dark'], 'dark') },
    ...
    borderColorBase: { default: color('borderColorBase', 'rgba(255, 255, 255, 0.15)') },
    ...
    emptyBottomColor: { default: color('emptyBottomColor', '#535353') },
    emptyDescriptionColor: { default: color('emptyDescriptionColor', 'rgba(255, 255, 255, 0.45)') },
    avatarBackground: { default: color('avatarBackground', 'rgb(222, 212, 212)') },
