...
describe('Text.vue', () => {
  ...
  it('text fontStyle', () => {
    ...
    expect(wrapper.find('div.sm-component-text').attributes()).toHaveProperty(
      'style',
      'font-size: 18px; line-height: 18px; font-weight: 700; justify-content: center; background: rgb(255, 255, 255); color: rgba(0, 0, 0, 0.65);'
    );
  });
