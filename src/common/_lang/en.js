export default {
  ...
  query: {
    ...
    sqlBuilderValueRequest: 'Get field unique values',
    sqlBuilderValuePreviousConditionIncomplete: 'Complete the previous conditions before getting field unique values',
